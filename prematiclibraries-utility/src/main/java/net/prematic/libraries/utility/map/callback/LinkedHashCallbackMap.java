...
public class LinkedHashCallbackMap<K,V> extends LinkedHashMap<K,V> implements CallbackMap<K,V>{
    ...
    public LinkedHashCallbackMap(int initialCapacity) {
        super(initialCapacity);
    }

    public LinkedHashCallbackMap() {
    }

    public LinkedHashCallbackMap(Map<? extends K, ? extends V> m) {
        super(m);
    }

    public LinkedHashCallbackMap(int initialCapacity, float loadFactor, boolean accessOrder) {
