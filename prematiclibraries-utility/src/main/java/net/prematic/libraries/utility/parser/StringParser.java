/*
 * (C) Copyright 2019 The PrematicWeb Project (Davide Wietlisbach & Philipp Elvin Friedhoff)
 *
 * @author Davide Wietlisbach
 * @since 25.04.19 09:44
 *
 * The PrematicWeb Project is under the Apache License, version 2.0 (the "License");
...
package net.prematic.libraries.utility.parser;
