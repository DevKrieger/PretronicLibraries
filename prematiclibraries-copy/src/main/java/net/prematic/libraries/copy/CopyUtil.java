...
package net.prematic.libraries.copy;

import net.prematic.libraries.copy.adapter.*;
import net.prematic.libraries.copy.annonations.CopyNull;
import net.prematic.libraries.copy.annonations.ForbidCopy;
import net.prematic.libraries.copy.annonations.ObjectCopyable;
import net.prematic.libraries.copy.annonations.ObjectDeepCopyable;
import net.prematic.libraries.utility.interfaces.Copyable;
import net.prematic.libraries.utility.interfaces.DeepCopyable;
