...
import net.pretronic.libraries.logging.AsyncPretronicLogger;
...
/**
 * This is a bridge for hooking pretronic logging service in the self4j logger.
 */
public class SLF4JBridge implements Logger {
    ...
    public SLF4JBridge() {
        this(new AsyncPretronicLogger());
    }

    public SLF4JBridge(PretronicLogger logger) {
        this.logger = logger;
    }
